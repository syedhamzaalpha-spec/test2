                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide ">
                        <div class=" border-1 border-teal-500 rounded-md  flex flex-col items-start  py-10 px-5">
                         ...
                         <p class="text-[clamp(12px,3vw,14px)] pt-2"> Safeguard yo business identity with our expert Trademark Registration services. Fast, reliable and tailored for businesses of all sizes. </p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                         <div class=" border-1 border-teal-500 rounded-md  flex flex-col items-start  py-10 px-5">
...
<!-- <div class="relative w-full max-w-sm">
    ...
    <span class="absolute inset-y-0 right-3 flex items-center">
        <img src="{{ asset('assets/img/chevron-right.svg') }}" width="18">
    </span>
    ...
    <input 
        ...
        class="w-full border border-gray-300 rounded-md py-2 pl-10 pr-3 focus:outline-none focus:border-teal-600"
    >
